...
SQLALCHEMY_DATABASE_URI = 'postgresql+psycopg2://postgres:@172.17.0.2:5432/postgres' if 'AWS_SAM_LOCAL' in os.environ else 'postgresql+psycopg2://postgres:postgres@database-2.ci7oifiiqx7r.us-east-2.rds.amazonaws.com:5432/gentem'
